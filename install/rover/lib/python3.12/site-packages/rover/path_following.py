...
class PathFollower(Node):
    def __init__(self):
        ...
        self.global_size = 120
        self.x_min_lim = self.tile_size * self.global_size / -2
        self.x_max_lim = self.x_min_lim * -1
        self.y_min_lim = self.tile_size * self.global_size / -2
        self.y_max_lim = self.y_min_lim * -1
    ...
    def pure_pursuit_control(self, target):
        ...
        # self.get_logger().info(str(self.rover_pos))
    ...
    def pure_pursuit(self):
        ...
        if sqrt((self.waypoints[0][0] - self.rover_pos[0])**2 + (self.waypoints[0][1] - self.rover_pos[1])**2) <= self.tile_size / 4.0:
    ...
    def waypoint_callback(self, msg):
        ...
        self.waypoints = (new_waypoints - (self.global_size / 2)) * self.tile_size + self.tile_size / 2
