"""
DEPRECATED PATH TRACKING ALGORITHM, NOW USE PURE PURSUIT. Previously used for slow point-to-point tracking.
Useful when odometry was not fused with IMU data (EKF), as it limited turning while moving.
"""
